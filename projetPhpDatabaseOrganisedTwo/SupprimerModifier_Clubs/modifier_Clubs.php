...
<body>
  ...
  $Clubs_Nom= $_GET['Clubs_Nom'];
  $Clubs_NomCourt= $_GET['Clubs_NomCourt'];
  $Clubs_Pays= $_GET['Clubs_Pays'];
   ?>
  ...
  <div class="container">
    <div class="contact-form row">
      <div class="form-field col-lg-6">
        <form class="" action="modifier_Clubs_get.php">
          <input id="name" class="input-text" type="text" value="<?php echo "$Clubs_Id" ?>" name="ClubId">
          <label for="name" class="label">Club Id</label>
        </div>
      <div class="form-field col-lg-6">
        <form class="" action="insertion_Clubs_Forum_Dans_Table.php">
          <input id="name" class="input-text" type="text" value="<?php echo "$Clubs_Nom" ?>" name="ClubNm">
          <label for="name" class="label">Club Nom</label>
        </div>
        <div class="form-field col-lg-6">
          <input id="name2" class="input-text" type="text" value="<?php echo "$Clubs_NomCourt" ?>" name="ClubNmcourt" >
          <label for="name2" class="label">Club Nom Court</label>
        </div>
        <div class="form-field col-lg-12">
          <input id="name3" class="input-text" type="text" value="<?php echo "$Clubs_Pays" ?>" name="ClubP" >
